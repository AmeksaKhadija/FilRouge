...
<body>
    <header class="navbar navbar-expand-lg navbar-white bg-white shadow sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#" style="color: #0c0c0c;"><span style="color: #2e42f1;" class="nav-brand-two">You</span>Choix</a>
            <form class="d-flex">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="#">List des sonneurs</a>
                </li>
                <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p>Transformez votre intérieur en un havre de confort et de style avec notre sélection exclusive de meubles de qualité. Chez YouChoix, nous vous offrons des pièces uniques et élégantes pour créer l'espace de vos rêves. Découvrez notre collection dès maintenant et donnez vie à votre vision de la perfection.</p>
                </div>
                <div class="col-lg-4 col-md-6">
